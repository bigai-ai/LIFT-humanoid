...
from lift_utils.types import Metrics
from lift_utils.types import Policy
from lift_utils.types import PolicyParams
from lift_utils.types import PRNGKey 
from lift_utils.types import SACTransition as Transition
from lift_utils.types import Observation
...
def actor_step(
    ...
    noise_scales: Observation = None,
) -> Tuple[State, Transition]:
    """Collect data."""
    actions, policy_extras = policy(env_state.obs, key, env_state.done, noise_scales)
